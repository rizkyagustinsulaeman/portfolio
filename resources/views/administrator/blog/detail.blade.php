                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group mandatory">
                                ...
                                <textarea name="deskripsi" id="inputDeskripsi" class="form-control" placeholder="Masukan Deskripsi" autocomplete="off"
                                    data-parsley-required="true" readonly>{!! $data->isi !!}</textarea>
                            </div>
                        </div>
                    </div>
