...
{
    private static $module = "kategori_blog";
    ...
    public function index(){
        ...
        return view('administrator.kategori_blog.index');
    }
        ...
        return DataTables::of($data)
            ->addColumn('action', function ($row) {
                ...
                if (isAllowed(static::$module, "edit")) : //Check permission
                    $btn .= '<a href="'.route('admin.kategori_blog.edit',$row->id).'" class="btn btn-primary btn-sm mx-3 ">
                    Edit
                </a>';
                endif;
                if (isAllowed(static::$module, "detail")) : //Check permission
                    $btn .= '<a href="#" data-id="' . $row->id . '" class="btn btn-secondary btn-sm " data-toggle="modal" data-target="#detailKategoriBlog">
                    Detail
                </a>';
                endif;
                return $btn;
    ...
    public function add(){
        ...
        return view('administrator.kategori_blog.add');
    }
    ...
    public function save(Request $request)
    {
        ...
        $rules = [
            'nama' => 'required|unique:kategori_blog',
            'status' => 'required',
        ];
        ...
        $cekSlugCount = KategoriBlog::where('slug', $slug)->count();
        ...
        return redirect()->route('admin.kategori_blog')->with('success', 'Data berhasil disimpan.');
    }
    ...
    public function edit($id){
        ...
        return view('administrator.kategori_blog.edit',compact('data'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $rules = [
            'nama' => 'required|unique:kategori_blog,nama,'.$id,
            'status' => 'required',
        ];
        ...
        $slug = Str::slug($request->nama);
        $cekSlugCount = KategoriBlog::where('id','!=',$id)->where('slug', $slug)->count();
        ...
        return redirect()->route('admin.kategori_blog')->with('success', 'Data berhasil diupdate.');
    }
    ...
    public function delete(Request $request)
    {
        ...
        $projects = Blog::where('kategori_id', $data->id)->get();
    ...
    public function getDetail($id){
        ...
        $data = KategoriBlog::with('blog')->find($id);
    ...
    public function checkNama(Request $request){
        if($request->ajax()){
            $users = KategoriBlog::where('nama', $request->nama)->withTrashed();
    ...
    public function arsip(){
        ...
        return view('administrator.kategori_blog.arsip');
    }
    ...
    public function restore(Request $request)
    {
        ...
        $data = KategoriBlog::onlyTrashed()->find($id);
        ...
        $projects = Blog::onlyTrashed()->where('kategori_id', $data->id)->get();
    ...
    public function forceDelete(Request $request)
    {
        ...
        // Check if data exists in the trash
        if (!$data) {
            return redirect()->route('admin.kategori_blog.arsip')->with('error', 'Data tidak ditemukan.');
        }
